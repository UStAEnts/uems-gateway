...
export namespace Messager {
    ...
    export class GatewayMessageHandler {
                ...
                conn.createChannel(function (err1, send_ch) {
                    ...
                    conn.createChannel(function (err2, rcv_ch) {
                        ...
                        rcv_ch.assertQueue(RCV_INBOX_QUEUE_NAME, {exclusive:true}, function (err3, queue) {
                            ...
                            const mh = new GatewayMessageHandler(conn, send_ch, rcv_ch);

                            rcv_ch.consume(queue.queue, function(msg: Message | null) {
        ...
        gatewayInternalMessageReceived(mh: GatewayMessageHandler, msg: Message | null) {
            ...
            if (msg == null) {
                ...
                console.log("Null message received - dropped");
                return;
            }
        ...
        sendRequest = async (key: string, data: any, data_id: Number, res: Response) => {
            ...
            this.outstanding_reqs.set(data_id, {
                unique_id: data_id,
                response: res,
                callback: function (res: Response, response_json: any) {
        ...
        add_events_handler(req: Request, res: Response, next: any) {
            throw new Error('Unimplemented');
        }
        
        get_events_handler = async (req: Request, res: Response, next: any) => {
        ...
        modify_events_handler(req: Request, res: Response, next: any) {
            throw new Error('Unimplemented');
        }
        
        remove_events_handler(req: Request, res: Response, next: any) {
            throw new Error('Unimplemented');
        }
...
function parse_get_event_req_to_message(req: Request) {
    return {
